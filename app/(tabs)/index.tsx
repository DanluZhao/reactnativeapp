...
export default function Index() {
  ...
  const isHabitCompleted = (habitId:string) =>{
    return completedHabits?.includes(habitId) ?? false; 
  }
  ...
  return (
    ...
    >
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        {habits?.length === 0 ? (
          <View style={styles.emptyState}><Text style={styles.emptyStateText}>No habits found, add your first habit</Text></View>
        ) : (
